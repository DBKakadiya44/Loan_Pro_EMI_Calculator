...
import com.loan.emi.loanpro_emicalculator.ADS.AppOpenManager;
import com.loan.emi.loanpro_emicalculator.ADS.SharedPrefs;
import com.loan.emi.loanpro_emicalculator.R;
import com.loan.emi.loanpro_emicalculator.databinding.ActivitySplashScreenBinding;
...
//                    timer.setText(String.valueOf(seconds));
    ...
    public void intentToHomeScreen() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(SplashScreenActivity.this, Intro1Activity.class));
                finish();
            }
        }, 2000);
